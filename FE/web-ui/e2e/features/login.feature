...
Feature: User login
    ...
    Scenario Outline: Unsuccessful login with invalid credentials
        ...
        Examples:
            ...
            | example@gmail.com     | WrongPassword123!  | Invalid credentials |
            | wrong_email@gmail.com | ExamplePassword123 | Invalid credentials |
            | wrong_email@gmail.com | WrongPassword123   | Invalid credentials |
